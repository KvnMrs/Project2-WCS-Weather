...
export const WeatherCard = ({ element }) => {
  return (
...
export const TemperatureCard = ({ element }) => {
  return (
    <div className="justify-self-center self-center ml-9 sm:pt-8">
      <div className="sm: grid grid-row-span-3 mt-2">
        <h2 className="text-3xl md:text-4xl">{Math.round(element.temp)} °C</h2>
      </div>
    </div>
  );
};

export const Forecast = ({ day, weather, temperature }) => {
  return (
